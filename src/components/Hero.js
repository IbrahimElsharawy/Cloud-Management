  ...
  return (
    <div className="w-full h-screen flex flex-col justify-between bg-zinc-200">
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        <div className="flex flex-col absolute bottom-[5%] bg-zinc-200 mx-1 md:left-1/2 transform md:-translate-x-1/2
        border border-slate-300 text-center shadow-xl py-8 rounded-xl md:min-w-[768px]
        ">
            <p>Data Services</p>
            <div className="flex justify-between flex-wrap px-4 ">
                <p className="flex px-4 py-2 text-slate-500"> <IoIosCloudUpload className="h-6 text-indigo-600"/>App Security</p>
